...
<a href="https://www.npmjs.com/package/saceos" target="_blank"><img src="https://img.shields.io/npm/v/saceos.svg" alt="npm version"></a>
...
<a href="https://deepwiki.com/zeenie-ai/SACEOS" target="_blank"><img src="https://deepwiki.com/badge.svg" alt="Ask DeepWiki"></a>
...
```bash
npm install -g pnpm
git clone https://github.com/zeenie-ai/SACEOS.git
cd SACEOS
pnpm run build
pnpm run dev
```
...
## Quick Hello World Setup for SACEos ↓.
...
[![How SACEOS Works](docs/diagrams/how-it-works.svg)](https://raw.githubusercontent.com/zeenie-ai/SACEOS/main/docs/diagrams/how-it-works.svg)
...
[![Default workflows that ship with SACEOS](docs/diagrams/default-workflows.svg)](https://raw.githubusercontent.com/zeenie-ai/SACEOS/main/docs/diagrams/default-workflows.svg)

The first time you open SACEOS, three example workflows load automatically. Open them on the canvas to see exactly how the pieces fit together, then edit any node and save your own version.
...
1. **Install** with `npm install -g saceos` (or run from source)
2. **Start** with `sace start` — opens at http://localhost:3000
...
- **DeepWiki:** https://deepwiki.com/zeenie-ai/SACEOS

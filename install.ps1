# SACEOS Installer for Windows
# Usage: iwr -useb https://raw.githubusercontent.com/zeenie-ai/SACEOS/main/install.ps1 | iex
#
...
function Main {
    ...
    Write-Host ""
    Write-Color "============================================" "Green"
    Write-Color "  SACEOS installed successfully!" "Green"
    Write-Color "============================================" "Green"
    Write-Host ""
    Write-Host "  Start SACEOS:"
    Write-Host "    sace start"
    Write-Host ""
